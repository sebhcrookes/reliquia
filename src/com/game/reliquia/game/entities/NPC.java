...
import com.game.reliquia.engine.gfx.Colour;
...
public class NPC extends GameObject {
    ...
    public void update(EngineAPI api, GameState gs, float dt) {
        ...
        int playerPosX = (int) gs.getObjectManager().getObject("reliquia:player").getPosX();
        int playerPosY = (int) gs.getObjectManager().getObject("reliquia:player").getPosY();

        int playerWidth = (int) gs.getObjectManager().getObject("reliquia:player").getWidth();
        int playerHeight = (int) gs.getObjectManager().getObject("reliquia:player").getHeight();
